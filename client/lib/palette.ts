...
export type TermColor = {
	...
	/**
	 * The human name — *Terracotta*, *Aqua*.
	 *
	 * A trailing comment on each row until the picker needed to *announce* its
	 * dots (D42). No screen prints one: sixteen bare circles read as "Choose
	 * color 7" to a screen reader and hover as nothing at all, so this is the
	 * `aria-label` and the `title`, and nothing else.
	 */
	name: string;
 ...
 * names are the spec's own labels, and the picker announces them.
 */
export const TERM_COLORS: readonly TermColor[] = [
	{ id: 'color-1',  name: 'Slate', base: '#456B80', tintBg: '#E8EDEF', tintBorder: '#D0DADF', tintText: '#456B80', darkDot: '#6A92A7', darkTintBg: '#30302B', darkTintBorder: '#364041', darkTintText: '#7CA0B4', onDrawer: '#7FA3B8' },
	{ id: 'color-2',  name: 'Denim', base: '#42618F', tintBg: '#E8EBF0', tintBorder: '#CFD6E0', tintText: '#42618F', darkDot: '#708CB5', darkTintBg: '#302F2E', darkTintBorder: '#343C47', darkTintText: '#839CC1' },
	{ id: 'color-3',  name: 'Indigo', base: '#5A548C', tintBg: '#EAE9EF', tintBorder: '#D3D2DD', tintText: '#5A548C', darkDot: '#8984B0', darkTintBg: '#332D2D', darkTintBorder: '#3D3746', darkTintText: '#9A96BD' },
	{ id: 'color-4',  name: 'Plum', base: '#6D4A69', tintBg: '#EEEAEE', tintBorder: '#DCD3DB', tintText: '#6D4A69', darkDot: '#A37F9F', darkTintBg: '#362B27', darkTintBorder: '#453339', darkTintText: '#AD8CAA', onDrawer: '#A17C9C' },
	{ id: 'color-5',  name: 'Mulberry', base: '#8E4468', tintBg: '#F0E8EC', tintBorder: '#E0CFD7', tintText: '#8E4468', darkDot: '#B67796', darkTintBg: '#3C2A27', darkTintBorder: '#513138', darkTintText: '#C28AA5' },
	{ id: 'color-6',  name: 'Brick', base: '#A03B36', tintBg: '#F1E7E7', tintBorder: '#E1CECE', tintText: '#A03B36', darkDot: '#C77773', darkTintBg: '#3F291F', darkTintBorder: '#582D25', darkTintText: '#CF8582', onDrawer: '#CB6B63' },
	{ id: 'color-7',  name: 'Terracotta', base: '#A85E33', tintBg: '#F1EBE7', tintBorder: '#E1D5CE', tintText: '#9C572F', darkDot: '#BF7A52', darkTintBg: '#402E1F', darkTintBorder: '#5B3B24', darkTintText: '#CB8F6C', onDrawer: '#D08A5C' },
	{ id: 'color-8',  name: 'Ochre', base: '#A5791D', tintBg: '#F1EEE7', tintBorder: '#E1DBCE', tintText: '#846117', darkDot: '#AE842B', darkTintBg: '#3F321B', darkTintBorder: '#5A451C', darkTintText: '#CA972E', onDrawer: '#D0A044' },
	{ id: 'color-9',  name: 'Mustard', base: '#8C7C22', tintBg: '#F1EFE7', tintBorder: '#E1DECE', tintText: '#7A6C1E', darkDot: '#9C8C31', darkTintBg: '#3B331C', darkTintBorder: '#50461E', darkTintText: '#B09D33' },
	{ id: 'color-10', name: 'Olive', base: '#5F7542', tintBg: '#ECEFE9', tintBorder: '#D8DED1', tintText: '#5B703F', darkDot: '#7A935A', darkTintBg: '#343221', darkTintBorder: '#3F432A', darkTintText: '#8AA467', onDrawer: '#93A96F' },
	{ id: 'color-11', name: 'Fern', base: '#3F7A4C', tintBg: '#E8F0EA', tintBorder: '#D0DFD3', tintText: '#3C7549', darkDot: '#579865', darkTintBg: '#2F3323', darkTintBorder: '#33452E', darkTintText: '#64A973' },
	{ id: 'color-12', name: 'Teal', base: '#3E6D68', tintBg: '#E9EFEE', tintBorder: '#D1DEDD', tintText: '#3E6D68', darkDot: '#5C948E', darkTintBg: '#2F3127', darkTintBorder: '#334038', darkTintText: '#6AA59F', onDrawer: '#6BA39C' },
	{ id: 'color-13', name: 'Aqua', base: '#2F6E7C', tintBg: '#E7EFF1', tintBorder: '#CEDEE1', tintText: '#2F6E7C', darkDot: '#4995A6', darkTintBg: '#2C312B', darkTintBorder: '#2D4140', darkTintText: '#51A3B5' },
	{ id: 'color-14', name: 'Clay', base: '#87694C', tintBg: '#EFECE9', tintBorder: '#DED7D1', tintText: '#7D6146', darkDot: '#A28467', darkTintBg: '#3B3023', darkTintBorder: '#4F3F2E', darkTintText: '#B1977D', onDrawer: '#B8977A' },
	{ id: 'color-15', name: 'Cocoa', base: '#5E4A3C', tintBg: '#EEEBE9', tintBorder: '#DDD7D2', tintText: '#5E4A3C', darkDot: '#A08674', darkTintBg: '#342B20', darkTintBorder: '#3F3328', darkTintText: '#AB9281' },
	{ id: 'color-16', name: 'Stone', base: '#6E6A5F', tintBg: '#EDECEB', tintBorder: '#D9D8D6', tintText: '#6A665B', darkDot: '#908C81', darkTintBg: '#373026', darkTintBorder: '#453F35', darkTintText: '#9F9B91' },
];
